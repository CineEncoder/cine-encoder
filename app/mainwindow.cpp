...
void MainWindow::encode()   //***************************************** Encode **********************//
{
    ...
    if (_mux_mode == true) {
        ...
        if (_fr_count == 0) {
            _status_encode_btn = "start";
            QIcon icon_start;
            icon_start.addFile(QString::fromUtf8(":/resources/icons/16x16/cil-media-play.png"), QSize(), QIcon::Normal, QIcon::Off);
...
void MainWindow::on_actionEncode_clicked()  // ********************* Encode button ***************** //
{
    if (_status_encode_btn == "start") {
        ...
        QIcon icon_pause;
        icon_pause.addFile(QString::fromUtf8(":/resources/icons/16x16/cil-media-pause.png"), QSize(), QIcon::Normal, QIcon::Off);
    ...
    if (_status_encode_btn == "pause") {
        ...
        QIcon icon_resume;
        icon_resume.addFile(QString::fromUtf8(":/resources/icons/16x16/cil-chevron-double-right.png"), QSize(), QIcon::Normal, QIcon::Off);
